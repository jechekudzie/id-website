...
<style>
  ...
  .slider_content_img .col-7 {
    flex: 1 1 48%;
    /* Each image takes approximately half of the row */
    max-width: 48%;
  ...
  @media (max-width: 768px) {
    .slider_content_img .row {
      display: flex;
      flex-direction: row;
      /* Maintain a single-row layout for images */
      flex-wrap: wrap;
      /* Wrap images to new lines as needed */
      gap: 10px;
      /* Add spacing */
    }
    ...
    .slider_content_img .col-7 {
      ...
      /* Each image takes 50% of the row with spacing */
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 position-relative z-2">
          <div class="slider_content_text">
            <p class="slider_subtitle text-white">Stories are what connect us. </p>
            <h1 style="color: #ea202e;" class="slider_title">
              <span class="text-wrapper">
                <span class="letters">Good ones make us feel. Better ones make us care. Great ones change how we see things.</span>
              </span>
            </h1>
    ...
    <div class="row align-items-end">
      <div class="col-lg-6 mb-8 mb-lg-0">
        ...
        <div class="contact_box shadow-sm">
          <img src="{{ asset('website/img/contact/blackb.jpg') }}" alt="" class="contact_img" />
          <ul class="contact_meta list-unstyled">
            <li><img src="{{ asset('website/img/general/blackb.jpg') }}" alt="" /></li>
